...
`;var O=!1,ee="all",P="off",me=null,Q=null,de=!1,T=new Map,W=new Map,pe=new WeakSet,x=new Set,Z=new Set,Me=window.location.href,C=null,L=null,k=null,ue=null,Ne=null,H=!1,j=new Set,A=null,$=null,E=!1;Se(e=>{switch(e.type){case"INSPECT_STATE":ye(e.active),E||G("crev_sync_inspect",{active:e.active});break;case"BADGE_ENRICHMENT":for(let[t,n]of Object.entries(e.enrichments))T.set(t,n);O&&ot();break;case"PAINT_STATE":P=e.phase,me=e.sourceName??null,ke(),E||G("crev_sync_paint",{phase:e.phase,sourceName:e.sourceName});break;case"PAINT_PREVIEW":at(e.rid,e.diff);break;case"PAINT_APPLY_RESULT":st(e.rid,e.ok,e.error);break;case"ENRICH_MODE":e.mode!==ee&&(ee=e.mode,O&&(x.clear(),be(),X()));break;case"RE_ENRICH":x.clear(),O&&X();break;case"CONNECTION_STATE":tt(e.state);break;case"PROFILE_SWITCHED":nt(e.label),E||G("crev_sync_profile",{label:e.label});break;case"TECHNICAL_OVERLAY_STATE":H=e.active,Ee(),E||G("crev_sync_overlay",{active:e.active});break}});Ie(()=>{if(x.clear(),C){let e=C;queueMicrotask(()=>{h({type:"DETECTION_RESULT",confidence:e.confidence,signals:e.signals,isBmp:e.isBmp})})}O&&X()});function tt(e){let t=Ne;Ne=e.display;let n=e.display==="connected"?"connected":e.display==="not-configured"?"not-configured":"disconnected",r=e.profileLabel??"CREV";C?.isBmp&&Re(r,n),t!==null&&t!==e.display&&(e.display==="connected"&&t!=="connected"?R(`Connected to ${e.profileLabel??"server"}`,"success"):e.display==="auth-failed"&&t!=="auth-failed"?R("Auth failed","error"):e.display==="unreachable"&&t!=="unreachable"?R("Server unreachable","error"):e.display==="server-down"&&t!=="server-down"&&R("Server down","error"))}function nt(e){R(`Switched to ${e}`,"info"),W.clear(),fe(),H&&Ee(),C?.isBmp&&Y(e,"connected")}function ye(e){O=e,e?(rt(),X()):(k&&(clearTimeout(k),k=null),be(),x.clear(),w())}function rt(){if(de)return;let e=document.createElement("style");e.id="crev-inspector-styles",e.textContent=Pe,document.head.appendChild(e);let t=document.createElement("div");t.id="crev-tooltip",document.body.appendChild(t),document.body.addEventListener("mouseover",r=>{if(!O)return;let o=r.target.closest?.(".crev-outline");if(o!==ue)if(ue=o,o){let u=o.querySelector("[data-crev-label]")?.getAttribute("data-crev-label");u&&ct(o,u)}else lt()});let n=m("div",{id:"crev-paint-banner"},m("span",{id:"crev-paint-text"},"Paint Format"),m("button",{class:"crev-paint-close",id:"crev-paint-close",onClick:()=>h({type:"TOGGLE_PAINT"})},"\u2715"));document.body.appendChild(n),de=!0}function De(e,t){let n=document.createElement("button");return n.className="crev-ec-btn",n.textContent=t==="CustomVisualization"?"</>":"EC",n.title="Open in editor",n.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),chrome.runtime.sendMessage({type:"OPEN_EDITOR",rid:e})}),n}function X(){for(let l of document.querySelectorAll(".crev-label"))(!l.parentElement||!document.body.contains(l.parentElement))&&l.remove();let e=ee==="all",t=ne(e),n=e?t.filter(({element:l})=>l.tagName==="A").length:0;y.debug("sync",`syncOverlays: ${t.length} elements (${n} links), enrichMode=${ee}`);let r=[],o=t.filter(({element:l})=>!pe.has(l));for(let{element:l,rid:d}of o){let c=T.get(d),p=K(c?.type);l.classList.add("crev-outline"),l.style.setProperty("--crev-color",p);let g=document.createElement("span");g.className="crev-label",c||g.classList.add("crev-label-loading"),g.setAttribute("data-crev-label",d);let a=document.createElement("span");a.className="crev-label-text",a.textContent=c?.businessId??c?.name??V(c?.type),g.appendChild(a),a.addEventListener("click",b=>{if(b.preventDefault(),b.stopPropagation(),P==="picking"){h({type:"PAINT_PICK",rid:d}),g.classList.add("crev-label-flash-pick"),setTimeout(()=>{g.classList.remove("crev-label-flash-pick")},400);return}if(P==="applying"){h({type:"PAINT_APPLY",rid:d});return}if($===d&&A){clearTimeout(A),A=null,$=null,it(g,d);return}$=d,A=setTimeout(()=>{A=null,$=null;let B=T.get(d)?.businessId??d;navigator.clipboard.writeText(B).then(()=>{let _=a.textContent;a.textContent="\u2713",g.classList.add("crev-label-flash-ok"),setTimeout(()=>{a.textContent=_,g.classList.remove("crev-label-flash-ok")},600)}).catch(_=>y.swallow("content:clipboard",_))},250)}),c?.type&&te.has(c.type)&&g.appendChild(De(d,c.type)),l.appendChild(g),pe.add(l),!T.has(d)&&!x.has(d)&&(r.push(d),x.add(d))}for(let{rid:l}of t)!T.has(l)&&!x.has(l)&&(r.push(l),x.add(l));r.length>0&&(y.debug("sync",`ENRICH_BADGES: sending ${r.length} RIDs`,r),h({type:"ENRICH_BADGES",rids:r}));let s=Date.now(),u=[];for(let{rid:l}of t)!Z.has(l)&&Z.size<5e3&&(Z.add(l),u.push({rid:l,source:"dom",discoveredAt:s,updatedAt:s}));u.length>0&&h({type:"OBJECTS_DISCOVERED",objects:u})}function be(){for(let t of document.querySelectorAll(".crev-label"))t.remove();for(let t of document.querySelectorAll(".crev-outline"))t.classList.remove("crev-outline"),t.style.removeProperty("--crev-color");let e=document.getElementById("crev-tooltip");e&&(e.style.display="none"),ue=null,pe=new WeakSet,W.clear()}function ot(){for(let e of document.querySelectorAll("[data-crev-label]")){let t=e.getAttribute("data-crev-label");if(!t)continue;let n=T.get(t);if(n){let r=e.querySelector(".crev-label-text");r&&(r.textContent=n.businessId??n.name??V(n.type)),e.classList.remove("crev-label-loading");let o=e.parentElement;if(o){let s=K(n.type);o.style.setProperty("--crev-color",s)}n.type&&te.has(n.type)&&!e.querySelector(".crev-ec-btn")&&e.appendChild(De(t,n.type))}}}function it(e,t){let n=T.get(t);chrome.runtime.sendMessage({type:"GET_FAVORITES"},r=>{r?.entries&&(j=new Set(r.entries.map(o=>o.rid))),Le(e,{rid:t,businessId:n?.businessId,type:n?.type,name:n?.name,isFavorite:j.has(t)},o=>{chrome.runtime.sendMessage({type:"OPEN_EDITOR",rid:o})},o=>{chrome.runtime.sendMessage({type:"TOGGLE_FAVORITE",rid:o,name:n?.name,objectType:n?.type,businessId:n?.businessId}),j.has(o)?j.delete(o):j.add(o)},o=>{chrome.runtime.sendMessage({type:"OPEN_OBJECT_VIEW",rid:o})})})}document.addEventListener("keydown",e=>{e.key==="Escape"&&ce()&&w()});document.addEventListener("click",e=>{!ce()||e.target.closest("#crev-quick-inspector")||w()},!0);function ge(...e){let t=document.getElementById("crev-paint-banner"),n=document.getElementById("crev-paint-text");if(!(!t||!n)){if(P==="off"){t.style.display="none";return}if(t.style.display="block",t.style.background="#ff832b",e.length>0){S(n,...e);return}P==="picking"?S(n,"Paint Format \u2014 ",m("b",null,"click a widget to pick its style")):S(n,"Paint Format from ",m("b",null,me??"?")," \u2014 click widgets to apply")}}function ke(){let e=P!=="off"?"crosshair":"pointer";for(let t of document.querySelectorAll(".crev-label-text"))t.style.cursor=e;ge()}function st(e,t,n){let r=document.querySelector(`[data-crev-label="${e}"]`);if(r){let o=t?"crev-label-flash-ok":"crev-label-flash-error";r.classList.add(o),setTimeout(()=>{r.classList.remove(o)},600)}if(t)R("Applied \u2014 refresh page to see changes","success");else{let o=n==="No source selected"?"Not connected \u2014 add a server in Connect tab":`Paint error: ${n??"unknown"}`;R(o,"error")}}function at(e,t){let n=document.getElementById("crev-paint-text");if(n){if(t.length===0){S(n,"No style differences \u2014 already identical"),setTimeout(()=>ge(),2e3);return}S(n,m("div",{style:"margin-bottom:3px"},"Style changes:"),...t.map(r=>m("div",{style:"font-size:10px;font-family:monospace;margin:1px 0"},m("b",null,r.prop),": ",r.from," \u2192 ",r.to)),m("div",{style:"margin-top:4px"},m("button",{class:"crev-paint-apply-btn",onClick:()=>{h({type:"PAINT_CONFIRM",rid:e}),S(n,"Applying\u2026")}},"Apply"),m("button",{class:"crev-paint-cancel-btn",onClick:()=>ge()},"Cancel")))}}function ct(e,t){L&&(clearTimeout(L),L=null);let n=document.getElementById("crev-tooltip");if(!n)return;let r=T.get(t),o=K(r?.type),s=V(r?.type),u=r?.type??(x.has(t)?"Loading\u2026":"Unknown");S(n,m("div",{class:"crev-tt-type",style:`background:${o}`},s)," ",m("span",{style:"color:#8d8d8d;font-size:10px"},u),r?.name&&m("div",{class:"crev-tt-name"},r.name),r?.businessId&&m("div",{class:"crev-tt-row"},`ID: ${r.businessId}`),m("div",{class:"crev-tt-row"},`RID: ${t}`)),n.style.top="-9999px",n.style.left="-9999px",n.style.display="block";let l=e.getBoundingClientRect(),d=n.getBoundingClientRect(),c=l.bottom+4,p=l.left;c+d.height>window.innerHeight&&(c=l.top-d.height-4),c<4&&(c=4),p+d.width>window.innerWidth&&(p=window.innerWidth-d.width-4),p<0&&(p=4),n.style.top=`${c}px`,n.style.left=`${p}px`}function lt(){L&&clearTimeout(L),L=setTimeout(()=>{let e=document.getElementById("crev-tooltip");e&&(e.style.display="none"),L=null},50)}q("crev_sync_inspect",e=>{let t=e;if(t.active!==O){E=!0;try{ye(t.active)}finally{E=!1}}});q("crev_sync_paint",e=>{let t=e;E=!0;try{P=t.phase,me=t.sourceName??null,ke()}finally{E=!1}});q("crev_sync_overlay",e=>{let t=e;if(t.active!==H){E=!0;try{H=t.active,Ee()}finally{E=!1}}});q("crev_sync_profile",e=>{let t=e;E=!0,C?.isBmp&&Y(t.label,t.connected!==!1?"connected":"disconnected"),E=!1});document.body.addEventListener("contextmenu",e=>{let t=e.target.closest?.("[data-rid]");if(t){let n=t.getAttribute("data-rid");if(n){let r=T.get(n);try{chrome.runtime.sendMessage({type:"SET_CONTEXT_RID",rid:n,name:r?.name,objectType:r?.type,businessId:r?.businessId})}catch(o){y.swallow("content:contextmenu",o)}}}},!0);var dt=new Set(["rid","id","name","type","__typename","typename","source","discoveredAt","updatedAt","treePath","webParentRid","hasChildren"]),pt=new Set(["expression","html","javascript"]),ut=6;function Ee(){if(H){let e=[];for(let t of document.querySelectorAll("[data-crev-label]")){let n=t.getAttribute("data-crev-label");n&&!W.has(n)&&e.push(n)}if(e.length>0)try{chrome.runtime.sendMessage({type:"GET_OVERLAY_PROPS",rids:e},t=>{if(!chrome.runtime.lastError&&t?.type==="OVERLAY_PROPS_DATA"&&t.props){for(let[n,r]of Object.entries(t.props))W.set(n,r);fe()}})}catch(t){y.swallow("content:getOverlayProps",t)}}fe()}function fe(){for(let e of document.querySelectorAll("[data-crev-label]")){let t=e.getAttribute("data-crev-label");if(!t)continue;let n=T.get(t),r=e.querySelector(".crev-label-text");if(r)if(H){e.classList.add("crev-label--card");let o=n?.type??"Unknown",s=n?.businessId??"",u=n?.name??"unnamed",l=t.length>12?t.slice(0,6)+"\u2026"+t.slice(-4):t;r.innerHTML="";let d=document.createElement("span");d.className="crev-card-line crev-card-type",d.textContent=s?`${o} | ${s}`:o;let c=document.createElement("span");c.className="crev-card-line",c.textContent=u;let p=document.createElement("span");p.className="crev-card-line crev-card-rid",p.textContent=l,r.appendChild(d),r.appendChild(c),r.appendChild(p);let g=W.get(t);if(g){let a=Object.entries(g).filter(([b])=>!dt.has(b));if(a.length>0){let b=document.createElement("span");b.className="crev-card-sep",r.appendChild(b);let M=0;for(let[B,_]of a){if(M>=ut)break;let z=document.createElement("span");if(z.className="crev-card-line crev-card-prop",pt.has(B)){let J=_.split(`
`).length;z.textContent=`${B}: ${J} line${J!==1?"s":""}`}else{let J=_.length>30?_.slice(0,27)+"\u2026":_;z.textContent=`${B}: ${J}`}r.appendChild(z),M++}}}}else e.classList.remove("crev-label--card"),r.innerHTML="",r.textContent=n?.businessId??n?.name??V(n?.type)}}function gt(){Q||(Q=new MutationObserver(e=>{e.every(n=>n.type!=="childList"||n.removedNodes.length>0?!1:Array.from(n.addedNodes).every(r=>r instanceof HTMLElement&&(r.classList.contains("crev-label")||r.id==="crev-tooltip")))||(window.location.href!==Me&&(Me=window.location.href,x.clear(),Z.clear(),A&&(clearTimeout(A),A=null,$=null),He()),O&&(k&&clearTimeout(k),k=setTimeout(()=>X(),150)))}),Q.observe(document.body,{childList:!0,subtree:!0}),window.__crev_observer=Q)}function He(){let e=re();C=e,h({type:"DETECTION_RESULT",confidence:e.confidence,signals:e.signals,isBmp:e.isBmp}),document.dispatchEvent(new CustomEvent("crev-content",{detail:{type:"CHECK_BMP_SIGNALS"}}))}document.addEventListener("crev-interceptor",(e=>{let t=e.detail;if(t.type==="OBJECTS_DISCOVERED"&&h(t),t.type==="BMP_SIGNALS_RESULT"){let n=t.signals??[];if(C&&n.length>0){let r=[...C.signals,...n],o=n.length*.15,s=Math.min(1,C.confidence+o),u=s>=.5;h({type:"DETECTION_RESULT",confidence:s,signals:r,isBmp:u})}}}));function ft(){let e=Te(),t=C??re(),n=t.isBmp?xe():[];return t.isBmp&&document.dispatchEvent(new CustomEvent("crev-content",{detail:{type:"EXTRACT_FIBERS"}})),{url:window.location.href,rid:e.rid,tabRid:e.tabRid,widgets:n,detection:{confidence:t.confidence,signals:t.signals,isBmp:t.isBmp}}}chrome.runtime.onMessage.addListener((e,t,n)=>{if(e.type==="INSPECT_STATE")return ye(e.active),!1;if(e.type==="GET_PAGE_INFO"){let r=ft();return n({type:"PAGE_INFO",...r}),!0}return e.type==="COPY_TO_CLIPBOARD"&&navigator.clipboard.writeText(e.text).catch(r=>y.swallow("content:clipboardWrite",r)),!1});function mt(){window.__crev_observer?.disconnect(),be(),w(),we(),document.getElementById("crev-inspector-styles")?.remove(),document.getElementById("crev-tooltip")?.remove(),document.getElementById("crev-paint-banner")?.remove(),document.getElementById("crev-toast-container")?.remove(),de=!1}window.__crev_content_loaded&&mt();window.__crev_content_loaded=!0;try{se()}catch(e){y.swallow("content:init:port",e)}try{He()}catch(e){y.swallow("content:init:detection",e)}try{gt()}catch(e){y.swallow("content:init:observer",e)}})();
