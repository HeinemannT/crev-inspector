...
`;var U=class{inspectActive=!1;enrichMode="all";paintPhase="off";paintSourceName=null;styleInjected=!1;technicalOverlay=!1;fromSync=!1;prevConnDisplay=null;lastUrl=typeof window<"u"?window.location.href:"";lastDetection=null;enrichments=new Map;overlayProps=new Map;badgedElements=new WeakSet;requestedRids=new Set;discoveredRids=new Set;favoriteRids=new Set;observer=null;tooltipHideTimer=null;debounceTimer=null;labelClickTimer=null;hoveredOutlineEl=null;labelClickRid=null;resetOverlays(){this.badgedElements=new WeakSet,this.requestedRids.clear(),this.overlayProps.clear(),this.labelClickTimer&&(clearTimeout(this.labelClickTimer),this.labelClickTimer=null),this.labelClickRid=null,this.hoveredOutlineEl=null}resetDiscovery(){this.discoveredRids.clear()}resetAll(){this.inspectActive=!1,this.enrichMode="all",this.paintPhase="off",this.paintSourceName=null,this.styleInjected=!1,this.technicalOverlay=!1,this.fromSync=!1,this.prevConnDisplay=null,this.lastUrl=typeof window<"u"?window.location.href:"",this.lastDetection=null,this.enrichments.clear(),this.resetOverlays(),this.resetDiscovery(),this.favoriteRids.clear(),this.debounceTimer&&(clearTimeout(this.debounceTimer),this.debounceTimer=null),this.tooltipHideTimer&&(clearTimeout(this.tooltipHideTimer),this.tooltipHideTimer=null),this.observer?.disconnect(),this.observer=null}};var ye=["BarChart","PieChart","LineChart","AreaChart","WaterfallChart","BubbleChart","RadarChart","TreeChart","GanttChart","NetworkChart","PolarChart","BarLineChart"],ke="#33b1ff",He={BarChart:"BAR",PieChart:"PIE",LineChart:"LIN",AreaChart:"ARA",WaterfallChart:"WFL",BubbleChart:"BUB",RadarChart:"RDR",TreeChart:"TRE",GanttChart:"GNT",NetworkChart:"NET",PolarChart:"PLR",BarLineChart:"BLC"},Be={Organisation:"#4589ff",Scorecard:"#08bdba",ExtendedTable:"#33b1ff",CustomVisualization:"#be95ff",DashboardFolder:"#ff7eb6",EditPage:"#42be65",StatusType:"#f1c21b",Strategy:"#78a9ff",Theme:"#08bdba",Perspective:"#82cfff",Objective:"#ff7eb6",Measure:"#42be65",Risk:"#fa4d56",Control:"#3ddbd9",Action:"#ff832b",...Object.fromEntries(ye.map(e=>[e,ke]))},Fe={Organisation:"ORG",Scorecard:"SC",ExtendedTable:"TBL",CustomVisualization:"CVO",DashboardFolder:"DSH",EditPage:"PG",StatusType:"ST",Strategy:"STR",Theme:"THM",Perspective:"PER",Objective:"OBJ",Measure:"MEA",Risk:"RSK",Control:"CTL",Action:"ACT",...He},ge="#8d8d8d";function V(e){return e?Be[e]??ge:ge}function M(e){return e?Fe[e]??e.substring(0,3).toUpperCase():"?"}var Ve={ExtendedTable:["expression"],ExtendedMethodConfig:["expression"],...Object.fromEntries(ye.map(e=>[e,["expression"]])),CustomVisualization:["html","javascript"]},be=new Set(Object.keys(Ve));function ve(e,t){let n=document.createElement("span");if(n.className="crev-actions",t.type&&be.has(t.type)){let o=document.createElement("button");o.className="crev-ec-btn",o.textContent=t.type==="CustomVisualization"?"</>":"EC",o.title="Open in editor",o.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),chrome.runtime.sendMessage({type:"OPEN_EDITOR",rid:e})}),n.appendChild(o)}let r=document.createElement("button");return r.className="crev-action-btn",r.textContent="\u2315",r.title="Find references",r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),chrome.runtime.sendMessage({type:"SEARCH_REFERENCES",rid:e,businessId:t.businessId,objectType:t.type,name:t.name})}),n.appendChild(r),n}function A(e){for(let d of document.querySelectorAll(".crev-label"))(!d.parentElement||!document.body.contains(d.parentElement))&&d.remove();let t=e.enrichMode==="all",n=W(t),r=t?n.filter(({element:d})=>d.tagName==="A").length:0;v.debug("sync",`syncOverlays: ${n.length} elements (${r} links), enrichMode=${e.enrichMode}`);let o=[],s=n.filter(({element:d})=>!e.badgedElements.has(d));for(let{element:d,rid:c}of s){let p=e.enrichments.get(c),m=V(p?.type);d.classList.add("crev-outline"),d.style.setProperty("--crev-color",m);let a=document.createElement("span");a.className="crev-label",p||a.classList.add("crev-label-loading"),a.setAttribute("data-crev-label",c);let g=document.createElement("span");g.className="crev-label-text",g.textContent=p?.businessId??p?.name??M(p?.type),a.appendChild(g),g.addEventListener("click",E=>{if(E.preventDefault(),E.stopPropagation(),e.paintPhase==="picking"){h({type:"PAINT_PICK",rid:c}),a.classList.add("crev-label-flash-pick"),setTimeout(()=>{a.classList.remove("crev-label-flash-pick")},400);return}if(e.paintPhase==="applying"){h({type:"PAINT_APPLY",rid:c});return}if(e.labelClickRid===c&&e.labelClickTimer){clearTimeout(e.labelClickTimer),e.labelClickTimer=null,e.labelClickRid=null,Ye(e,a,c);return}let N=E.shiftKey;e.labelClickRid=c,e.labelClickTimer=setTimeout(()=>{e.labelClickTimer=null,e.labelClickRid=null;let I=e.enrichments.get(c),R=!!I?.templateBusinessId,w=N&&R?I.templateBusinessId:I?.businessId??c,O=N&&R?"\u2713 Tmpl":"\u2713";navigator.clipboard.writeText(w).then(()=>{let j=g.textContent;g.textContent=O,a.classList.add("crev-label-flash-ok"),setTimeout(()=>{g.textContent=j,a.classList.remove("crev-label-flash-ok")},600)}).catch(j=>v.swallow("content:clipboard",j))},250)}),d.appendChild(a),p&&d.appendChild(ve(c,p)),e.badgedElements.add(d),!e.enrichments.has(c)&&!e.requestedRids.has(c)&&(o.push(c),e.requestedRids.add(c))}for(let{rid:d}of n)!e.enrichments.has(d)&&!e.requestedRids.has(d)&&(o.push(d),e.requestedRids.add(d));o.length>0&&(v.debug("sync",`ENRICH_BADGES: sending ${o.length} RIDs`,o),h({type:"ENRICH_BADGES",rids:o}));let u=Date.now(),b=[];for(let{rid:d}of n)!e.discoveredRids.has(d)&&e.discoveredRids.size<5e3&&(e.discoveredRids.add(d),b.push({rid:d,source:"dom",discoveredAt:u,updatedAt:u}));b.length>0&&h({type:"OBJECTS_DISCOVERED",objects:b})}function q(e){for(let n of document.querySelectorAll(".crev-label"))n.remove();for(let n of document.querySelectorAll(".crev-actions"))n.remove();for(let n of document.querySelectorAll(".crev-outline"))n.classList.remove("crev-outline"),n.style.removeProperty("--crev-color");let t=document.getElementById("crev-tooltip");t&&(t.style.display="none"),e.hoveredOutlineEl=null,e.badgedElements=new WeakSet,e.overlayProps.clear()}function he(e){for(let t of document.querySelectorAll("[data-crev-label]")){let n=t.getAttribute("data-crev-label");if(!n)continue;let r=e.enrichments.get(n);if(r){let o=t.querySelector(".crev-label-text");o&&(o.textContent=r.businessId??r.name??M(r.type)),t.classList.remove("crev-label-loading");let s=t.parentElement;if(s){let u=V(r.type);s.style.setProperty("--crev-color",u)}s&&!s.querySelector(".crev-actions")&&s.appendChild(ve(n,r))}}}function Ye(e,t,n){let r=e.enrichments.get(n);chrome.runtime.sendMessage({type:"GET_FAVORITES"},o=>{o?.entries&&(e.favoriteRids=new Set(o.entries.map(s=>s.rid))),me(t,{rid:n,businessId:r?.businessId,templateBusinessId:r?.templateBusinessId,type:r?.type,name:r?.name,isFavorite:e.favoriteRids.has(n)},s=>{chrome.runtime.sendMessage({type:"OPEN_EDITOR",rid:s})},s=>{chrome.runtime.sendMessage({type:"TOGGLE_FAVORITE",rid:s,name:r?.name,objectType:r?.type,businessId:r?.businessId}),e.favoriteRids.has(s)?e.favoriteRids.delete(s):e.favoriteRids.add(s)},s=>{chrome.runtime.sendMessage({type:"OPEN_OBJECT_VIEW",rid:s})})})}function ee(e,...t){let n=document.getElementById("crev-paint-banner"),r=document.getElementById("crev-paint-text");if(!(!n||!r)){if(e.paintPhase==="off"){n.style.display="none";return}if(n.style.display="block",n.style.background="#ff832b",t.length>0){C(r,...t);return}e.paintPhase==="picking"?C(r,"Paint Format \u2014 ",y("b",null,"click a widget to pick its style")):C(r,"Paint Format from ",y("b",null,e.paintSourceName??"?")," \u2014 click widgets to apply")}}function te(e){let t=e.paintPhase!=="off"?"crosshair":"pointer";for(let n of document.querySelectorAll(".crev-label-text"))n.style.cursor=t;ee(e)}function Ee(e,t,n){let r=document.querySelector(`[data-crev-label="${e}"]`);if(r){let o=t?"crev-label-flash-ok":"crev-label-flash-error";r.classList.add(o),setTimeout(()=>{r.classList.remove(o)},600)}if(t)x("Applied \u2014 refresh page to see changes","success");else{let o=n==="No source selected"?"Not connected \u2014 add a server in Connect tab":`Paint error: ${n??"unknown"}`;x(o,"error")}}function Te(e,t,n){let r=document.getElementById("crev-paint-text");if(r){if(n.length===0){C(r,"No style differences \u2014 already identical"),setTimeout(()=>ee(e),2e3);return}C(r,y("div",{style:"margin-bottom:3px"},"Style changes:"),...n.map(o=>y("div",{style:"font-size:10px;font-family:monospace;margin:1px 0"},y("b",null,o.prop),": ",o.from," \u2192 ",o.to)),y("div",{style:"margin-top:4px"},y("button",{class:"crev-paint-apply-btn",onClick:()=>{h({type:"PAINT_CONFIRM",rid:t}),C(r,"Applying\u2026")}},"Apply"),y("button",{class:"crev-paint-cancel-btn",onClick:()=>ee(e)},"Cancel")))}}var Ge=new Set(["rid","id","name","type","__typename","typename","source","discoveredAt","updatedAt","treePath","webParentRid","hasChildren"]),je=new Set(["expression","html","javascript"]),We=6;function Ce(e,t,n){e.tooltipHideTimer&&(clearTimeout(e.tooltipHideTimer),e.tooltipHideTimer=null);let r=document.getElementById("crev-tooltip");if(!r)return;let o=e.enrichments.get(n),s=V(o?.type),u=M(o?.type),b=o?.type??(e.requestedRids.has(n)?"Loading\u2026":"Unknown");C(r,y("div",{class:"crev-tt-type",style:`background:${s}`},u)," ",y("span",{style:"color:#8d8d8d;font-size:10px"},b),o?.name&&y("div",{class:"crev-tt-name"},o.name),o?.businessId&&y("div",{class:"crev-tt-row"},`ID: ${o.businessId}`),y("div",{class:"crev-tt-row"},`RID: ${n}`)),r.style.top="-9999px",r.style.left="-9999px",r.style.display="block";let d=t.getBoundingClientRect(),c=r.getBoundingClientRect(),p=d.bottom+4,m=d.left;p+c.height>window.innerHeight&&(p=d.top-c.height-4),p<4&&(p=4),m+c.width>window.innerWidth&&(m=window.innerWidth-c.width-4),m<0&&(m=4),r.style.top=`${p}px`,r.style.left=`${m}px`}function xe(e){e.tooltipHideTimer&&clearTimeout(e.tooltipHideTimer),e.tooltipHideTimer=setTimeout(()=>{let t=document.getElementById("crev-tooltip");t&&(t.style.display="none"),e.tooltipHideTimer=null},50)}function G(e){if(e.technicalOverlay){let t=[];for(let n of document.querySelectorAll("[data-crev-label]")){let r=n.getAttribute("data-crev-label");r&&!e.overlayProps.has(r)&&t.push(r)}if(t.length>0)try{chrome.runtime.sendMessage({type:"GET_OVERLAY_PROPS",rids:t},n=>{if(!chrome.runtime.lastError&&n?.type==="OVERLAY_PROPS_DATA"&&n.props){for(let[r,o]of Object.entries(n.props))e.overlayProps.set(r,o);Y(e)}})}catch{}}Y(e)}function Y(e){for(let t of document.querySelectorAll("[data-crev-label]")){let n=t.getAttribute("data-crev-label");if(!n)continue;let r=e.enrichments.get(n),o=t.querySelector(".crev-label-text");if(o)if(e.technicalOverlay){t.classList.add("crev-label--card");let s=r?.type??"Unknown",u=r?.businessId??"",b=r?.name??"unnamed",d=n.length>12?n.slice(0,6)+"\u2026"+n.slice(-4):n;o.innerHTML="";let c=document.createElement("span");c.className="crev-card-line crev-card-type",c.textContent=u?`${s} | ${u}`:s;let p=document.createElement("span");p.className="crev-card-line",p.textContent=b;let m=document.createElement("span");m.className="crev-card-line crev-card-rid",m.textContent=d,o.appendChild(c),o.appendChild(p),o.appendChild(m);let a=e.overlayProps.get(n);if(a){let g=Object.entries(a).filter(([E])=>!Ge.has(E));if(g.length>0){let E=document.createElement("span");E.className="crev-card-sep",o.appendChild(E);let N=0;for(let[I,R]of g){if(N>=We)break;let w=document.createElement("span");if(w.className="crev-card-line crev-card-prop",je.has(I)){let O=R.split(`
`).length;w.textContent=`${I}: ${O} line${O!==1?"s":""}`}else{let O=R.length>30?R.slice(0,27)+"\u2026":R;w.textContent=`${I}: ${O}`}o.appendChild(w),N++}}}}else t.classList.remove("crev-label--card"),o.innerHTML="",o.textContent=r?.businessId??r?.name??M(r?.type)}}function Se(e,t){e.observer||(e.observer=new MutationObserver(n=>{n.every(o=>o.type!=="childList"||o.removedNodes.length>0?!1:Array.from(o.addedNodes).every(s=>s instanceof HTMLElement&&(s.classList.contains("crev-label")||s.id==="crev-tooltip")))||(window.location.href!==e.lastUrl&&(e.lastUrl=window.location.href,e.resetOverlays(),e.resetDiscovery(),t()),e.inspectActive&&(e.debounceTimer&&clearTimeout(e.debounceTimer),e.debounceTimer=setTimeout(()=>A(e),150)))}),e.observer.observe(document.body,{childList:!0,subtree:!0}),window.__crev_observer=e.observer)}var i=new U;function ne(e){i.inspectActive=e,e?(ze(),A(i)):(i.debounceTimer&&(clearTimeout(i.debounceTimer),i.debounceTimer=null),q(i),i.requestedRids.clear(),_())}function ze(){if(i.styleInjected)return;let e=document.createElement("style");e.id="crev-inspector-styles",e.textContent=fe,document.head.appendChild(e);let t=document.createElement("div");t.id="crev-tooltip",document.body.appendChild(t),document.body.addEventListener("mouseover",r=>{if(!i.inspectActive)return;let o=r.target.closest?.(".crev-outline");if(o!==i.hoveredOutlineEl)if(i.hoveredOutlineEl=o,o){let u=o.querySelector("[data-crev-label]")?.getAttribute("data-crev-label");u&&Ce(i,o,u)}else xe(i)});let n=y("div",{id:"crev-paint-banner"},y("span",{id:"crev-paint-text"},"Paint Format"),y("button",{class:"crev-paint-close",id:"crev-paint-close",onClick:()=>h({type:"TOGGLE_PAINT"})},"\u2715"));document.body.appendChild(n),i.styleInjected=!0}function Xe(e){let t=i.prevConnDisplay;i.prevConnDisplay=e.display;let n=e.display==="connected"?"connected":e.display==="not-configured"?"not-configured":"disconnected",r=e.profileLabel??"CREV";i.lastDetection?.isBmp&&le(r,n),t!==null&&t!==e.display&&(e.display==="connected"&&t!=="connected"?x(`Connected to ${e.profileLabel??"server"}`,"success"):e.display==="auth-failed"&&t!=="auth-failed"?x("Auth failed","error"):e.display==="unreachable"&&t!=="unreachable"?x("Server unreachable","error"):e.display==="server-down"&&t!=="server-down"&&x("Server down","error"))}function Ke(e){x(`Switched to ${e}`,"info"),i.overlayProps.clear(),Y(i),i.technicalOverlay&&G(i),i.lastDetection?.isBmp&&H(e,"connected")}function _e(){let e=$();i.lastDetection=e,h({type:"DETECTION_RESULT",confidence:e.confidence,signals:e.signals,isBmp:e.isBmp}),document.dispatchEvent(new CustomEvent("crev-content",{detail:{type:"CHECK_BMP_SIGNALS"}}))}function Qe(){let e=re(),t=i.lastDetection??$(),n=t.isBmp?oe():[];return t.isBmp&&document.dispatchEvent(new CustomEvent("crev-content",{detail:{type:"EXTRACT_FIBERS"}})),{url:window.location.href,rid:e.rid,tabRid:e.tabRid,widgets:n,detection:{confidence:t.confidence,signals:t.signals,isBmp:t.isBmp}}}ae(e=>{switch(e.type){case"INSPECT_STATE":ne(e.active),i.fromSync||B("crev_sync_inspect",{active:e.active});break;case"BADGE_ENRICHMENT":for(let[t,n]of Object.entries(e.enrichments))i.enrichments.set(t,n);i.inspectActive&&he(i);break;case"PAINT_STATE":i.paintPhase=e.phase,i.paintSourceName=e.sourceName??null,te(i),i.fromSync||B("crev_sync_paint",{phase:e.phase,sourceName:e.sourceName});break;case"PAINT_PREVIEW":Te(i,e.rid,e.diff);break;case"PAINT_APPLY_RESULT":Ee(e.rid,e.ok,e.error);break;case"ENRICH_MODE":e.mode!==i.enrichMode&&(i.enrichMode=e.mode,i.inspectActive&&(i.requestedRids.clear(),q(i),A(i)));break;case"RE_ENRICH":i.requestedRids.clear(),i.inspectActive&&A(i);break;case"CONNECTION_STATE":Xe(e.state);break;case"PROFILE_SWITCHED":Ke(e.label),i.fromSync||B("crev_sync_profile",{label:e.label});break;case"TECHNICAL_OVERLAY_STATE":i.technicalOverlay=e.active,G(i),i.fromSync||B("crev_sync_overlay",{active:e.active});break}});ce(()=>{if(i.requestedRids.clear(),i.lastDetection){let e=i.lastDetection;queueMicrotask(()=>{h({type:"DETECTION_RESULT",confidence:e.confidence,signals:e.signals,isBmp:e.isBmp})})}i.inspectActive&&A(i)});F("crev_sync_inspect",e=>{let t=e;if(t.active!==i.inspectActive){i.fromSync=!0;try{ne(t.active)}finally{i.fromSync=!1}}});F("crev_sync_paint",e=>{let t=e;i.fromSync=!0;try{i.paintPhase=t.phase,i.paintSourceName=t.sourceName??null,te(i)}finally{i.fromSync=!1}});F("crev_sync_overlay",e=>{let t=e;if(t.active!==i.technicalOverlay){i.fromSync=!0;try{i.technicalOverlay=t.active,G(i)}finally{i.fromSync=!1}}});F("crev_sync_profile",e=>{let t=e;i.fromSync=!0,i.lastDetection?.isBmp&&H(t.label,t.connected!==!1?"connected":"disconnected"),i.fromSync=!1});document.body.addEventListener("contextmenu",e=>{let t=e.target.closest?.("[data-rid]");if(t){let n=t.getAttribute("data-rid");if(n){let r=i.enrichments.get(n);try{chrome.runtime.sendMessage({type:"SET_CONTEXT_RID",rid:n,name:r?.name,objectType:r?.type,businessId:r?.businessId})}catch(o){v.swallow("content:contextmenu",o)}}}},!0);document.addEventListener("keydown",e=>{e.key==="Escape"&&J()&&_()});document.addEventListener("click",e=>{!J()||e.target.closest("#crev-quick-inspector")||_()},!0);document.addEventListener("crev-interceptor",(e=>{let t=e.detail;if(t.type==="OBJECTS_DISCOVERED"&&h(t),t.type==="BMP_SIGNALS_RESULT"){let n=t.signals??[];if(i.lastDetection&&n.length>0){let r=[...i.lastDetection.signals,...n],o=n.length*.15,s=Math.min(1,i.lastDetection.confidence+o),u=s>=.5;h({type:"DETECTION_RESULT",confidence:s,signals:r,isBmp:u})}}}));chrome.runtime.onMessage.addListener((e,t,n)=>{if(e.type==="INSPECT_STATE")return ne(e.active),!1;if(e.type==="GET_PAGE_INFO"){let r=Qe();return n({type:"PAGE_INFO",...r}),!0}return e.type==="COPY_TO_CLIPBOARD"&&navigator.clipboard.writeText(e.text).catch(r=>v.swallow("content:clipboardWrite",r)),!1});function Je(){i.observer?.disconnect(),q(i),_(),de(),document.getElementById("crev-inspector-styles")?.remove(),document.getElementById("crev-tooltip")?.remove(),document.getElementById("crev-paint-banner")?.remove(),document.getElementById("crev-toast-container")?.remove(),i.styleInjected=!1}window.__crev_content_loaded&&Je();window.__crev_content_loaded=!0;try{K()}catch(e){v.swallow("content:init:port",e)}try{_e()}catch(e){v.swallow("content:init:detection",e)}try{Se(i,_e)}catch(e){v.swallow("content:init:observer",e)}})();
