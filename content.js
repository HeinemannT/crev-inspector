...
.crev-label {
  ...
  padding: 2px 8px;
  border-radius: 2px;
  border-left: 2px solid var(--crev-color, #8d8d8d);
...
#crev-tooltip .crev-tt-type {
  ...
  font-weight: 600;
  color: #fff;
  background: var(--type-color, #8d8d8d);
  margin-bottom: 3px;
}
