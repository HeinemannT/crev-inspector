...
/** Copy button — used in detail view and page tab.
 *  Optional tooltip override. If shiftText is provided via the tooltip hint,
 *  the caller should wire shift-click separately (see copyBtnDual). */
