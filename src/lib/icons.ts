...
// Filled paintbrush — the Paint tile's "armed/loaded" glyph (the stroked ICON_PAINT was too faint at corner size).
export const ICON_PAINT_FILL = '<svg width="14" height="14" viewBox="0 0 256 256" fill="currentColor"><path d="M232,32a8,8,0,0,0-8.34-.49c-49.16,25-71.81,53.91-82,73.65a55.49,55.49,0,0,0-44.34,16C71.13,156.32,71.74,184.32,72,191c-7.7,8.61-8,29-8,35.05a8,8,0,0,0,8,8c6.07,0,26.44-.31,35.05-8,6.71.26,34.71.87,69.86-25.32a55.49,55.49,0,0,0,16-44.34c19.74-10.17,48.67-32.82,73.65-82A8,8,0,0,0,232,32Z"/></svg>';
